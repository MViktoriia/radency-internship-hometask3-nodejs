...
exports.updateArchivedSchema = exports.updateNoteSchema = exports.addNoteSchema = void 0;
...
exports.addNoteSchema = joi_1.default.object({
    ...
    category: joi_1.default.string().valid("Task", "Random Thought", "Idea", "Quote").required(),
